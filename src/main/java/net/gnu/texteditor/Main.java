...
public class Main extends Fragment implements JotaDocumentWatcher, ShortcutListener,
        OnFileLoadListener {
	...
	SlidingTabsFragment slidingTabsFragment;
	...
	public static Main newInstance(Intent intent, String title) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        activity = (TextEditorActivity) this.getActivity();
...
//int co = 0;
    ...
    public void onChanged() {
		...
		//Log.e(TAG, "changed " + changed + ", " + title);
//		if (++co == 7) {
...
//		}
		...
		String name = filename.endsWith("*") ? filename.substring(0, filename.length() - 1) : filename;//getString(R.string.app_name);//
        if (mInstanceState.filename != null) {
		...
		activity.slideFrag.updateTitle(this, name);
    }
...
//			mToolbarBase.addView(textView, 0);
		}
